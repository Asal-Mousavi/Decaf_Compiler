...
_lr_productions = [
  ...
  ('program -> CLASS PROGRAM OPEN field_decl method_decl CLOSE','program',6,'p_program','phase3_semantic_analysis.py',36),
  ('field_decl -> type field_decl_1 SEMI','field_decl',3,'p_field_decl','phase3_semantic_analysis.py',42),
  ('field_decl -> field_decl field_decl','field_decl',2,'p_field_decl','phase3_semantic_analysis.py',43),
  ('field_decl -> field_decl NEWLINE','field_decl',2,'p_field_decl','phase3_semantic_analysis.py',44),
  ('field_decl -> empty','field_decl',1,'p_field_decl','phase3_semantic_analysis.py',45),
  ('field_decl_1 -> IDENTIFIER','field_decl_1',1,'p_field_decl_1','phase3_semantic_analysis.py',51),
  ('field_decl_1 -> IDENTIFIER O_BRACKET int_literal C_BRACKET','field_decl_1',4,'p_field_decl_1','phase3_semantic_analysis.py',52),
  ('field_decl_1 -> field_decl_1 COMMA field_decl_1','field_decl_1',3,'p_field_decl_1','phase3_semantic_analysis.py',53),
  ('method_decl -> type_or_void IDENTIFIER O_PAR type_and_id C_PAR block','method_decl',6,'p_method_decl','phase3_semantic_analysis.py',61),
  ('method_decl -> method_decl NEWLINE','method_decl',2,'p_method_decl','phase3_semantic_analysis.py',62),
  ('method_decl -> method_decl method_decl','method_decl',2,'p_method_decl','phase3_semantic_analysis.py',63),
  ('method_decl -> empty','method_decl',1,'p_method_decl','phase3_semantic_analysis.py',64),
  ('type_and_id -> type IDENTIFIER','type_and_id',2,'p_type_and_id','phase3_semantic_analysis.py',71),
  ('type_and_id -> type_and_id COMMA type_and_id','type_and_id',3,'p_type_and_id','phase3_semantic_analysis.py',72),
  ('type_or_void -> type','type_or_void',1,'p_type_or_void','phase3_semantic_analysis.py',80),
  ('type_or_void -> VOID','type_or_void',1,'p_type_or_void','phase3_semantic_analysis.py',81),
  ('block -> OPEN var_decl statement CLOSE','block',4,'p_block','phase3_semantic_analysis.py',88),
  ('block -> OPEN CLOSE','block',2,'p_block','phase3_semantic_analysis.py',89),
  ('var_decl -> type var_decl_1 SEMI','var_decl',3,'p_var_decl','phase3_semantic_analysis.py',95),
  ('var_decl -> var_decl var_decl NEWLINE','var_decl',3,'p_var_decl','phase3_semantic_analysis.py',96),
  ('var_decl -> empty','var_decl',1,'p_var_decl','phase3_semantic_analysis.py',97),
  ('var_decl_1 -> IDENTIFIER','var_decl_1',1,'p_var_decl_1','phase3_semantic_analysis.py',103),
  ('var_decl_1 -> var_decl_1 COMMA var_decl_1','var_decl_1',3,'p_var_decl_1','phase3_semantic_analysis.py',104),
  ('type -> INT','type',1,'p_type','phase3_semantic_analysis.py',110),
  ('type -> BOOLEAN','type',1,'p_type','phase3_semantic_analysis.py',111),
  ('statement -> location ASSIGN expr SEMI','statement',4,'p_statement','phase3_semantic_analysis.py',116),
  ('statement -> method_call SEMI','statement',2,'p_statement','phase3_semantic_analysis.py',117),
  ('statement -> IF O_PAR expr C_PAR block NEWLINE else_or_empty','statement',7,'p_statement','phase3_semantic_analysis.py',118),
  ('statement -> WHILE O_PAR expr C_PAR block','statement',5,'p_statement','phase3_semantic_analysis.py',119),
  ('statement -> RETURN expr_or_empty SEMI','statement',3,'p_statement','phase3_semantic_analysis.py',120),
  ('statement -> BREAK SEMI','statement',2,'p_statement','phase3_semantic_analysis.py',121),
  ('statement -> CONTINUE SEMI','statement',2,'p_statement','phase3_semantic_analysis.py',122),
  ('statement -> block','statement',1,'p_statement','phase3_semantic_analysis.py',123),
  ('statement -> statement statement','statement',2,'p_statement','phase3_semantic_analysis.py',124),
  ('statement -> statement NEWLINE','statement',2,'p_statement','phase3_semantic_analysis.py',125),
  ('statement -> empty','statement',1,'p_statement','phase3_semantic_analysis.py',126),
  ('expr_or_empty -> expr','expr_or_empty',1,'p_expr_or_empty','phase3_semantic_analysis.py',141),
  ('expr_or_empty -> empty','expr_or_empty',1,'p_expr_or_empty','phase3_semantic_analysis.py',142),
  ('else_or_empty -> ELSE block','else_or_empty',2,'p_else_or_empty','phase3_semantic_analysis.py',147),
  ('else_or_empty -> else_or_empty else_or_empty','else_or_empty',2,'p_else_or_empty','phase3_semantic_analysis.py',148),
  ('else_or_empty -> empty','else_or_empty',1,'p_else_or_empty','phase3_semantic_analysis.py',149),
  ('method_call -> method_name O_PAR arg C_PAR','method_call',4,'p_method_call','phase3_semantic_analysis.py',156),
  ('method_call -> CALLOUT O_PAR string_literal C_PAR','method_call',4,'p_method_call','phase3_semantic_analysis.py',157),
  ('method_call -> CALLOUT O_PAR string_literal COMMA call COMMA C_PAR','method_call',7,'p_method_call','phase3_semantic_analysis.py',158),
  ('method_name -> IDENTIFIER','method_name',1,'p_method_name','phase3_semantic_analysis.py',164),
  ('arg -> expr','arg',1,'p_arg','phase3_semantic_analysis.py',170),
  ('arg -> expr COMMA arg','arg',3,'p_arg','phase3_semantic_analysis.py',171),
  ('location -> IDENTIFIER','location',1,'p_location','phase3_semantic_analysis.py',177),
  ('location -> IDENTIFIER O_BRACKET expr C_BRACKET','location',4,'p_location','phase3_semantic_analysis.py',178),
  ('expr -> location','expr',1,'p_expr','phase3_semantic_analysis.py',186),
  ('expr -> literal','expr',1,'p_expr','phase3_semantic_analysis.py',187),
  ('expr -> expr bin_op expr','expr',3,'p_expr','phase3_semantic_analysis.py',188),
  ('expr -> NEGATIVE expr','expr',2,'p_expr','phase3_semantic_analysis.py',189),
  ('expr -> EXCL expr','expr',2,'p_expr','phase3_semantic_analysis.py',190),
  ('expr -> O_PAR expr C_PAR','expr',3,'p_expr','phase3_semantic_analysis.py',191),
  ('call -> callout_arg','call',1,'p_call','phase3_semantic_analysis.py',211),
  ('call -> callout_arg call','call',2,'p_call','phase3_semantic_analysis.py',212),
  ('callout_arg -> expr','callout_arg',1,'p_callout_arg','phase3_semantic_analysis.py',219),
  ('callout_arg -> string_literal','callout_arg',1,'p_callout_arg','phase3_semantic_analysis.py',220),
  ('callout_arg -> callout_arg','callout_arg',1,'p_callout_arg','phase3_semantic_analysis.py',221),
  ('bin_op -> ARITH_OP','bin_op',1,'p_bin_op','phase3_semantic_analysis.py',228),
  ('bin_op -> REP_OP','bin_op',1,'p_bin_op','phase3_semantic_analysis.py',229),
  ('bin_op -> EQ_OP','bin_op',1,'p_bin_op','phase3_semantic_analysis.py',230),
  ('bin_op -> COND_OP','bin_op',1,'p_bin_op','phase3_semantic_analysis.py',231),
  ('literal -> int_literal','literal',1,'p_literal','phase3_semantic_analysis.py',238),
  ('literal -> char_literal','literal',1,'p_literal','phase3_semantic_analysis.py',239),
  ('literal -> bool_literal','literal',1,'p_literal','phase3_semantic_analysis.py',240),
  ('int_literal -> DECIMAL','int_literal',1,'p_int_literal','phase3_semantic_analysis.py',247),
  ('int_literal -> HEXDECIMAL','int_literal',1,'p_int_literal','phase3_semantic_analysis.py',248),
  ('bool_literal -> TRUE','bool_literal',1,'p_bool_literal','phase3_semantic_analysis.py',255),
  ('bool_literal -> FALSE','bool_literal',1,'p_bool_literal','phase3_semantic_analysis.py',256),
  ('char_literal -> CHAR','char_literal',1,'p_char_literal','phase3_semantic_analysis.py',263),
  ('string_literal -> STRING','string_literal',1,'p_string_literal','phase3_semantic_analysis.py',270),
  ('empty -> <empty>','empty',0,'p_empty','phase3_semantic_analysis.py',276),
]
